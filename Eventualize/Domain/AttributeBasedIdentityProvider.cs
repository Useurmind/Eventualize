...
namespace Eventualize.Domain
{
    ...
    {
        public BoundedContext GetAggregateBoundedContext(Type aggregateType)
        {
            ...
            return new BoundedContext(boundedContextAttribute.Name);
        }
        ...
        public EventType GetEventTypeName(IEventData eventData)
        {
            return this.GetEventTypeName(eventData.GetType());
        }

        public EventType GetEventTypeName(Type eventType)
        {
